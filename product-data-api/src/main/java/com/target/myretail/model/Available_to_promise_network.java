...
/*public class Available_to_promise_network {
    ...
    private Date loyalty_purchase_start_date_time;
	...
	public Available_to_promise_network() {
	
	}
	
	public Available_to_promise_network(int product_id, String id_type, double available_to_promise_quantity,
			Date street_date, String availability, double online_available_to_promise_quantity,
			double stores_available_to_promise_quantity, String availability_status, String[] multichannel_options,
			boolean is_infinite_inventory, String loyalty_availability_status, Date loyalty_purchase_start_date_time,
			boolean is_loyalty_purchase_enabled, boolean is_out_of_stock_in_all_store_locations,
			boolean is_out_of_stock_in_all_online_locations) {
		super();
	...
	public boolean isIs_infinite_inventory() {
	...
	public Date getLoyalty_purchase_start_date_time() {
		return loyalty_purchase_start_date_time;
	}
	public void setLoyalty_purchase_start_date_time(Date loyalty_purchase_start_date_time) {
		this.loyalty_purchase_start_date_time = loyalty_purchase_start_date_time;
	}
	public boolean isIs_loyalty_purchase_enabled() {
		return is_loyalty_purchase_enabled;
	}
	public void setIs_loyalty_purchase_enabled(boolean is_loyalty_purchase_enabled) {
		this.is_loyalty_purchase_enabled = is_loyalty_purchase_enabled;
	}
	public boolean isIs_out_of_stock_in_all_store_locations() {
	...
	public boolean isIs_out_of_stock_in_all_online_locations() {
	...
	public String toString() {
		return "Available_to_promise_network [product_id=" + product_id + ", id_type=" + id_type
				...
				+ ", multichannel_options=" + Arrays.toString(multichannel_options) + ", is_infinite_inventory="
				+ is_infinite_inventory + ", loyalty_availability_status=" + loyalty_availability_status
				+ ", loyalty_purchase_start_date_time=" + loyalty_purchase_start_date_time
				+ ", is_loyalty_purchase_enabled=" + is_loyalty_purchase_enabled
